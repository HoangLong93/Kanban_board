<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditTask.aspx.cs" Inherits="Kanban.EditTask" %>
    ...
    <div class ="divNewT" >
       ...
       <div class ="divNewT1" >
        ...
        <div class="divNewT2">
            ...
            <br/>
            <asp:TextBox ID="TextBoxComplexity" runat="server" Width="94px" CssClass="marginright50" Text="0"></asp:TextBox>
        ...
        <asp:Button CssClass ="NewTAdd"  ID="ButtonEditTask" runat="server" Text="Edit Task" Height="34px" Width="103px" OnClick="ButtonEditTask_Click"/>
